...
/*
 * This class holds the attributes and methods for an Object List
 * when creating, deleting, or manipulating Object Lists throughout the program,
 * this class is called
 */

public class ObjectList implements ObjectListInterface, Comparable {
    private ObjectListNode list;
    private ObjectListNode last;
    
    /*
     * implements methods from comparable
     * @see Comparable#compareTo(java.lang.Object)
     */
    public int compareTo(Object o){
    	ObjectList e = (ObjectList) o;
		int result = size()-(e.size());
		if(result>0){
			return 1;
		}
		if(result<0){
     ...
     * @see ObjectListInterface#getFirstNode()
     */
     ...
     * @see ObjectListInterface#getLastNode()
     */
     ...
     * @see ObjectListInterface#getFirst()
     */
     ...
     * @see ObjectListInterface#getLast()
     */
     ...
     * @see ObjectListInterface#addFirst(java.lang.Object)
     */
